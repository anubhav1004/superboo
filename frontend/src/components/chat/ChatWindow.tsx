...
const QUICK_START = [
  ...
  },
  {
    emoji: "\uD83C\uDFAC",
    title: "Make a video",
    desc: "Create a 15-second video about space exploration.",
    prompt: "Create a 15-second video about space exploration",
    color: "#69D8C4",
  },
  {
    emoji: "\uD83C\uDFAE",
    title: "Build a game",
    desc: "Create a quiz game about world capitals.",
    prompt: "Create a quiz game about world capitals",
    color: "#9FE870",
  },
  {
    emoji: "\uD83C\uDFA8",
    title: "Design a poster",
    desc: "Design a poster for my birthday party.",
    prompt: "Design a poster for my birthday party",
    color: "#F3C969",
  },
  {
    emoji: "\uD83D\uDCDA",
  ...
  },
  {
    emoji: "\uD83C\uDFB5",
    title: "Write a song",
    desc: "Write a fun song about my dog named Biscuit.",
    prompt: "Write a fun song about my dog named Biscuit",
    color: "#F48E8C",
  },
];
